...
def test_create_access_token(test_settings_env_dict: dict) -> None:
    test_settings_env_dict["ACCESS_TOKEN_EXPIRE_MINUTES"] = "5"
...
def test_create_access_token_with_expires_data(test_settings_env_dict: dict) -> None:
    test_settings_env_dict["ACCESS_TOKEN_EXPIRE_MINUTES"] = "5"
    with mock.patch.dict(os.environ, test_settings_env_dict):
        from app.core.config import settings
        from app.core.auth import create_access_token, decode_token
...
def test_create_tokens(test_settings_env_dict: dict) -> None:
    with mock.patch.dict(os.environ, test_settings_env_dict):
        from app.core.config import settings
